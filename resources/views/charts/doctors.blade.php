        ...
        <div class="input-daterange datepicker row align-items-center" data-date-format="yyyy-mm-dd">
            <div class="col">
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Fecha de inicio" type="text" value="{{$start}}" id="startDate">
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="Fecha de fin" type="text" value="{{$end}}" id="endDate">
                    </div>
                </div>
            </div>
        </div>
